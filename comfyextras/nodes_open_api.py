...
class FsSpecShadowboxMetadata(TypedDict, total=True):
    prompt_json_str: str
...
class LegacyOutputURIs(CustomNode):
    ...
    def INPUT_TYPES(cls) -> InputTypes:
        return {
            "required": {
                "images": ("IMAGE",),
                "prefix": ("STRING", {"default": "Shadowbox_"}),
    ...
    def execute(self, images: Sequence[Tensor], prefix: str = "Shadowbox_", suffix: str = "_.png") -> ValidatedNodeResult:
...
class SaveImagesResponse(CustomNode):
    ...
    def execute(self,
        ...
        for batch_number, (image, uri, metadata_uri, local_uri, exif_inst) in enumerate(zip(images, uris, metadata_uris, local_uris, exif)):
            ...
            fsspec_metadata: FsSpecShadowboxMetadata = {
